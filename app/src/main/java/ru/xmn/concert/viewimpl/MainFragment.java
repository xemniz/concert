...
public class MainFragment extends Fragment implements EventListView {
    ...
    private void initRecyclerView(View v) {
        ...
        mEventAdapter = new EventAdapter(mEvents, getActivity().getBaseContext());
...
//                mMainPresenter.setVkList();
    ...
    @Override
    public void loadEventList(List<EventRealm> eventRealms) {
        mEvents.addAll(eventRealms);
